...
export class TeamComponent {
  ...
  public team = [ {
    ...
    description: 'Мемкойны - местная валюта, которую можно получить за победу в битвах или с помощью майнинга. ' +
      ...
      'После того как вы закончили майнинг, вам начисляют заработанные мемкойны, новую кирку вы получите через 1 час',
    borderColor: 'gold'
  }, {
    ...
    description: 'Звания - это уровень вышей прокачки. ' +
