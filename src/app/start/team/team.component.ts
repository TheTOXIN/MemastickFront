...
export class TeamComponent {
  ...
  public team = [ {
    ...
    description: 'Мемотипы это аналог - "стикеров", на темы самых популярных мемов. Они делятся на 5 видов редкости: КЛАССИЧЕСКИЙ, ГОДНЫЙ, ОРНЫЙ, МЕМИЧЕСКИЙ, СВЕРХ МЕМОТИП. Мемотипы можно: покупать и обменивать',
    borderColor: 'cornflowerblue'
  }, {
    image: 'assets/images/info/4.png',
    social: this._sanitizer.bypassSecurityTrustHtml('МОТИВАТОРЫ'),
    message: 'Это все тебе',
    description: 'Мотиваторы - это вознаграждения которые даются за заслуги в исследованиях. Они бывают 3 видов: ПОСОБИЕ - содержит токены, дается ежедневно, зависит от уровня меметика. ПРЕМИИ - содержит токены и днк, дается за переодичные достижения в системе. ГРАНТЫ - получают за определеные цели и иследования, дают новые возможности меметикам',
    borderColor: '#B10800'
  }, {
    ...
    description: 'Мемкойны - местная валюта, которую можно получить только за победу в батлах. Мемкойны свободный ресурс и его можно будет передовать другим. Потрать мемкойны можно на покупку мемотипов, или воскрешение мема',
    borderColor: 'gold'
  }, {
    image: 'assets/images/info/5.png',
    social: this._sanitizer.bypassSecurityTrustHtml('ЗВАНИЯ'),
    message: 'Мама я хочу быть мемологом',
    description: 'Звания - это уровень вышей прокачки. Чем больше ДНК, тем выше ваше звание, чем выше звание, тем больше у вас возможностей. Максимальный уровень это 50, что равняется 1.000.000 ДНК. С каждым 10 уровнем вы получаете новый вид токена к пособию.',
    borderColor: '#34992c'
  }, {
